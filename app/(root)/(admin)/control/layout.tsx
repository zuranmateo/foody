...
export default async function ControlLayout({
    ...
    return (
        <main className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-7xl flex-col gap-6 px-4 py-6 lg:flex-row lg:px-6">
            <AdminSidebar />
            <section className="flex-1 rounded-3xl border bg-card p-5 shadow-sm lg:p-8">
